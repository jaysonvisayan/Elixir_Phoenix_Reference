...
# RegistrationLinkWeb.Endpoint.init/2 when load_from_system_env is
...
config :registration_link, RegistrationLinkWeb.Endpoint,
  ...
  server: true,
  root: ".",
  version: Application.spec(:registration_link, :vsn),
  env: "${APP_SIGNAL_ENV}"
...
# start per endpoint:
#
#     config :registration_link, RegistrationLinkWeb.Endpoint, server: true
#
...
config :sentry,
  ...
  tags: %{
    env: "${SENTRY_ENV}",
    app_version: "#{Application.spec(:registration_link, :vsn)}"
  },
