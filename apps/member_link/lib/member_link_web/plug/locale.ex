defmodule MemberLinkWeb.Plug.Locale do
  @moduledoc false
  import Plug.Conn
  ...
  def call(conn, default) do
    ...
    if is_ietf_tag && locale in MemberLinkWeb.Gettext.supported_locales do
  ...
  defp assign_locale!(conn, value) do
    ...
    Gettext.put_locale(MemberLinkWeb.Gettext, value)
    conn
    |> assign(:locale, value)
  end
