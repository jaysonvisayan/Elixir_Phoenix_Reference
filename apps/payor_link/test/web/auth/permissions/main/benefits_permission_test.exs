defmodule Innerpeace.PayorLink.Web.Permission.Main.BenefitTest do
  ...
  describe "Benefit Permission /web/benefits" do
    test "with manage_benefits should have access to index", %{conn: conn} do
      ...
      conn = get authenticated(conn, u), main_benefit_path(conn, :index)
