defmodule Innerpeace.Db.Validator.OPLabValidatorTest do
  ...
  setup do
    ...
    facility_payor_procedure_2 = insert(:facility_payor_procedure,
                                      facility: facility,
                                      payor_procedure: payor_procedure_2)

    facility_payor_procedure_3 = insert(:facility_payor_procedure,
                                      facility: facility,
    ...
    product_coverage_risk_share = insert(:product_coverage_risk_share,
                                         product_coverage: product_coverage,
                                         af_type: "Copayment",
    ...
    product_coverage_risk_share_facility = insert(:product_coverage_risk_share_facility,
    ...
    insert(:product_coverage_risk_share_facility_procedure,
            product_coverage_risk_share_facility: product_coverage_risk_share_facility,
            facility_payor_procedure: facility_payor_procedure_2,
            type: "Copayment",
            value_amount: 50,
            covered: 100)
  ...
  test "request opconsult with invalid params" do
    ...
    changeset = OPLab.changeset(%OPLab{}, params)
    refute changeset.valid? == true
  end

  # test "check_pec/1", %{member: member, authorization: authorization, coverage: coverage, diagnosis1: diagnosis, product: product} do
  #   exclusion = insert(:exclusion, coverage: "Pre-existing Condition")
  #   exclusion_disease = insert(:exclusion_disease, exclusion: exclusion, disease: diagnosis)
  #   insert(:product_exclusion, product: product, exclusion: exclusion)
  #   insert(:authorization_procedure_diagnosis, diagnosis: diagnosis, authorization: authorization)
  #   member = member_preloads(member)
  #   authorization = authorization_preloads(authorization)
  #   raise OPLabValidator.setup_products_of_member(member, coverage, authorization)
  # end

  # TODO: Make this work
  # test "request oplab with positive result", %{
  #   practitioner: practitioner,
  ...
  #     ],
  #     "facility_id" => facility.id,
  #     "procedure_id" => [payor_procedure.id, payor_procedure_2.id, payor_procedure_3.id],
  #     "admission_datetime" => Ecto.DateTime.cast!("2012-12-12 00:00:00")
  #   }

  # {:ok, changeset} = OPLabValidator.request_web_op_lab(params)
