defmodule Innerpeace.AccountLink.Email do
  @moduledoc false
  ...
  defp commstack_login() do
    ...
    mailer = Application.get_env(:payor_link, AccountLink.Mailer)
    body = Poison.encode!(%{
      username: mailer |> Keyword.get(:username),
      password: mailer |> Keyword.get(:password)
    })
    case HTTPoison.post(
      url,
      body,
