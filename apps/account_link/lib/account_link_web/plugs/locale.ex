defmodule AccountLinkWeb.Plug.Locale do
  @moduledoc false
  ...
  def call(conn, default) do
    ...
    if is_ietf_tag && locale in AccountLinkWeb.Gettext.supported_locales do
  ...
  defp assign_locale!(conn, value) do
    ...
    Gettext.put_locale(AccountLinkWeb.Gettext, value)
    conn
    |> assign(:locale, value)
  end
  ...
  defp extract_locale(conn) do
    ...
    locales =
      locales
      |> Enum.filter(fn locale -> Enum.member?(AccountLinkWeb.Gettext.supported_locales, locale) end)
  end
